package com.rizki.alfatest.ext.event
...
import com.rizki.alfatest.app.domain.ResultWrapper
import com.rizki.alfatest.app.domain.safeApiCall
import com.skollaedutech.skolla.ext.constant.NetworkCodes
import com.rizki.alfatest.ext.other.ErrorCodesMapper
import com.skollaedutech.skolla.ext.provider.SchedulerProvider
...
abstract class NetworkBoundResource<ResultType, RequestType>(
    ...
    fun asFlow(): Flow<Resource<ResultType>> = flow {
        // check if should fetch data from remote or not (should catch data from api or not)
        if (shouldFetch()) {
            if (shouldFetchWithLocalData()) { // should emit cached date with loading state or not (should get data from local or not)
...
import com.skollaedutech.skolla.app.domain.subscribers.Resource
